...
static const uint32_t TestData_Msg_ops [] =
{
  ...
  DDS_OP_ADR | DDS_OP_TYPE_SEQ | DDS_OP_SUBTYPE_1BY, offsetof (TestData_Msg, sequence_field),
  DDS_OP_RTS
};
...
const dds_topic_descriptor_t TestData_Inner_TopicMsg_desc =
{
  ...
  "<MetaData version=\"1.0.0\"><Module name=\"TestData\"><Module name=\"Inner\"><Struct name=\"InnerMsg\"><Member name=\"userID\"><Long/></Member><Member name=\"message\"><String/></Member></Struct><Struct name=\"TopicMsg\"><Member name=\"inner_msg\"><Type name=\"InnerMsg\"/></Member><Member name=\"topicID\"><String/></Member></Struct></Module></Module></MetaData>"
};
